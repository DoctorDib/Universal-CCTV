...
from CameraModules.CameraBase import CameraBase
from Resources.Config import Config
from Resources.Info import Info
from Resources.SQLiteManager import SQLiteManager
from Resources.Streaming import StreamingServer
...
class Camera(CameraBase):
    ...
    def delete_snapshot(self, uid: int, name: str):
        super().delete_snapshot(uid, name)
        self.info.get_snapshot_files()
    ...
    def _start_recording(self):
        ...
        self.current_uid = self.sqlite_manager.insert_video(time_stamp, video_format)
    ...
    def _stop_recording(self):
        ...
        # Setting recording flag to false in database
        self.sqlite_manager.stop_recording(self.current_uid) 
